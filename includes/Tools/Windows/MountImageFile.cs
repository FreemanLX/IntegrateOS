...
namespace IntegrateOS.Tools.Windows
{
    ...
    public partial class MountImageFile : MetroFramework.Forms.MetroForm
    {
        int index1;
        public MountImageFile(System.Drawing.Point punct, int index)
        {
            InitializeComponent();
            Location = punct;
            index1 = index;
        ...
        private void Reselecting_image_path_Click(object sender, EventArgs e) => Moving.Form(this, new SelectInstallationMode(Location, 1));
        ...
        private void MountUnmount_Click(object sender, EventArgs e)
        {
            ...
            if (mounted == false && pass == 0)
            {
                ...
                new LoadingResponse(mount_thread, "Mounting selected Windows Image File").ShowDialog();
            }
            if (mounted == true && pass == 0)
            {
                ...
                new LoadingResponse(unmount_thread, "Unmounting selected Windows Image File").ShowDialog();
            }
        }
        ...
        private void Back_Click(object sender, EventArgs e) => Moving.Form(this, new PrincipalForm(Location));
    }
}
