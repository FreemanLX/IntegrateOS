...
namespace IntegrateOS
{
    public partial class Set_partition : MetroFramework.Forms.MetroForm
    {
        ...
        private void Next_Click(object sender, EventArgs e)
        {
            ...
            new Async_Processing(new System.Threading.Thread(() => FormatDrive(comboBox1.Text, textBox1.Text, comboBox3.Text, quick_format, t)), "Formating the selected partition").ShowDialog();
            Close();
        }
    }
}
