...
namespace IntegrateOS
{
    public partial class Select_Windows_Edition : MetroFramework.Forms.MetroForm
    {
        ...
        {
            Thread.Sleep(500);
            if (Getting_WindowsInfo(get_path) == false) Moving.Form(this, new Default_form(Location));
        }
        ...
        private void Refresh_Click(object sender, EventArgs e)
        {
            ...
            new Async_Processing(new Thread(() => Getting_the_windows_infos()), "Retrive windows editions").ShowDialog();
        }

        private void Moving_Selection_OS_Click(object sender, EventArgs e) => Moving.Form(this, new Default_form(Location));

        private void Select_Windows_Edition_Shown(object sender, EventArgs e) => new Async_Processing(new Thread(() => Getting_the_windows_infos()), "Retrive windows editions").ShowDialog();
        ...
        private void Windows_Editions_List_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            switch (j)
            {
                ...
                case 2:
                    ...
                    Moving.Form(this, new Select_installation(Location, 3));
                    break;
                case 1:
                    Moving.Form(this, new Mount_Windows(Location, Windows_Editions_List.CurrentCell.RowIndex + 1));
                    break;
            }
        }
    }
