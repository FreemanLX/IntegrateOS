...
namespace IntegrateOS
{
    public partial class Settings : MetroFramework.Forms.MetroForm
    {
        ...
        private void Settings_Load(object sender, EventArgs e)
        {
            ...
            Colors.Text = Colors.GetItemText(MetroDefaults.Convert_to_String((int)Themes.MetroColor - 1));
            Dark.Checked = temp;  White.Checked = !temp;
        }

        private void Dark_CheckedChanged(object sender, EventArgs e)
        {
            Themes.MetroTheme = Form_StyleManager.Theme = MetroThemeStyle.Dark;
            Back.BackgroundImage = Resources.black_left_arrow;
        }

        private void White_CheckedChanged(object sender, EventArgs e)
        {
            Themes.MetroTheme = Form_StyleManager.Theme = MetroThemeStyle.Light;
        ...
        private void MetroComboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Themes.MetroColor = Form_StyleManager.Style;
        }
