...
namespace ManagedWimLib
{
    ...
    internal static class NativeMethods
    {
        ...
        #region GetImageInfo - GetImageDescription, GetImageName, GetImageProperty
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate IntPtr wimlib_get_image_description(IntPtr wim, int image);
        internal static wimlib_get_image_description GetImageDescription;

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate IntPtr wimlib_get_image_name(IntPtr wim, int image);
        internal static wimlib_get_image_name GetImageName;

        internal static IntPtr GetImageProperty(IntPtr wim, int image, string property_name)
        {
            return UseUtf16
        ...
        #region GetWimInfo - GetWimInfo, GetXmlData, IsImageNameInUse, ResolveImage
        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate ErrorCode wimlib_get_wim_info(IntPtr wim, IntPtr info);
        internal static wimlib_get_wim_info GetWimInfo;

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate ErrorCode wimlib_get_xml_data(IntPtr wim, ref IntPtr buf_ret, ref IntPtr bufsize_ret); // size_t
        internal static wimlib_get_xml_data GetXmlData;

        internal static bool IsImageNameInUse(IntPtr wim, string name)
        {
            return UseUtf16
        ...
        internal static int ResolveImage(IntPtr wim, string image_name_or_num)
        {
            return UseUtf16 ? Utf16.ResolveImage(wim, image_name_or_num) : Utf8.ResolveImage(wim, image_name_or_num);
        }
        #endregion
        ...
        #region Join - Join, JoinWithProgress
        internal static ErrorCode Join(string[] swms, uint num_swms, string output_path, OpenFlags swms_open_flags, WriteFlags write_flags)
        {
            return UseUtf16
        ...
        internal static ErrorCode JoinWithProgress(string[] swms, uint num_swms, string output_path, OpenFlags swms_open_flags, WriteFlags write_flags, NativeProgressFunc progfunc, IntPtr progctx)
        {
            return UseUtf16
        ...
        #region Open - OpenWim, OpenWithProgress
        internal static ErrorCode OpenWim(string wim_file, OpenFlags open_flags, out IntPtr wim_ret)
        {
            return UseUtf16
        ...
        internal static ErrorCode OpenWimWithProgress(string wim_file, OpenFlags open_flags, out IntPtr wim_ret, NativeProgressFunc progfunc, IntPtr progctx)
        {
            return UseUtf16
        ...
        internal static ErrorCode ReferenceResourceFiles(IntPtr wim, string[] resource_wimfiles_or_globs, uint count, RefFlags ref_flags, OpenFlags open_flags)
        {
            return UseUtf16
        ...
        #region Rename - RenamePath
        internal static ErrorCode RenamePath(IntPtr wim, int image, string source_path, string dest_path)
        {
            return UseUtf16 ? Utf16.RenamePath(wim, image, source_path, dest_path) : Utf8.RenamePath(wim, image, source_path, dest_path);
        }
        #endregion
        ...
        #region Write - Write, Overwrite
        internal static ErrorCode Write(IntPtr wim, string path, int image, WriteFlags write_flags, uint num_threads)
        {
            return UseUtf16 ? Utf16.Write(wim, path, image, write_flags, num_threads) : Utf8.Write(wim, path, image, write_flags, num_threads);
        }

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        internal delegate ErrorCode wimlib_overwrite(IntPtr wim, WriteFlags write_flags, uint numThreads);
