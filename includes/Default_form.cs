...
{
    public partial class Default_form : MetroForm
    {

        public Thread check_login_user;

        public Default_form(Point point)
        {
            Location = point;
            InitializeComponent();
        }
        ...
        private void DoubleClickEvent(object sender, EventArgs e)
        {
            ...
            switch (IntegrateOS_Data.list_of_history_codes.Last())
            {
                case "menu":
                    {
                ...
                case "selectos":
                    if(tile_sender.Text == "Windows") Moving.Form(this, new IntegrateOS.Select_installation(Location));
                    break;
                    ...
                    switch (tile_sender.Text)
                    {
                        ...
                        case "Boot to Advanced boot options":
                            if (MetroFramework.MetroMessageBox.Show(this, "Are you sure you want to see the Advanced options of Windows ?", 
                                ...
                                Generate_Process.Static_BackgroundWorker_Process("shutdown.exe -r -o -t 0", "cmd.exe");               
                            break;
                    }
                    break;
                ...
                case "wadvancedtools":
                    switch (tile_sender.Text)
                    {
                        ...
                        case "Uninstall all Windows drivers":
                            ...
                            {
                                Generate_Process x = new Generate_Process();
        ...
        public void Check_if_logged()
        {
            ...
            while (true)
            {
                if (IntegrateOS_Data.user != null)
                {

                    Invoke(new Action(() => { 
                        label4.Text = IntegrateOS_Data.user.Email;
        ...
        private void Go_before()
        {
            ...
            LayoutPanel.Refresh();
            IntegrateOS_Data.list_of_history_codes.Remove(IntegrateOS_Data.list_of_history_codes.Last());
            if(IntegrateOS_Data.list_of_history_codes.Last() == "menu") metroButton2.Visible = false;
            Set_metroTiles(IntegrateOS_Data.list_of_history_codes.Last());
        }
        ...
        private void Change(string code)
        {
            LayoutPanel.Controls.Clear();
            LayoutPanel.Refresh();
            IntegrateOS_Data.list_of_history_codes.Add(code);
            Set_metroTiles(code);
        }
        ...
        private void Default_form_Load(object sender, EventArgs e)
        {
            ...
            if (GetOSInfo() == 0 && IntegrateOS_Data.verify_windows_boolean == 1)
            {
                ...
                IntegrateOS_Data.verify_windows_boolean = 0;
            }
